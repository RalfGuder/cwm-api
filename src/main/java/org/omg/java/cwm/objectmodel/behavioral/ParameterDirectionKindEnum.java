...
implements org.omg.java.cwm.objectmodel.behavioral.ParameterDirectionKind, java.io.Serializable {
...
public static final org.omg.java.cwm.objectmodel.behavioral.ParameterDirectionKindEnum PDK_IN = new ParameterDirectionKindEnum("pdk_in");
  ...
  private static final java.util.List<String> typeName = java.util.Collections.unmodifiableList(java.util.Arrays.asList(new String[] {"Behavioral","ParameterDirectionKind"}));
  ...
  public boolean equals( java.lang.Object other ) {
    return (other instanceof org.omg.java.cwm.objectmodel.behavioral.ParameterDirectionKindEnum) ? other == this: false;
  }
