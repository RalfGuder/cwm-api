 ...
 * ModelElement(s) that must be true for the model to be well formed. This
 ...
 * language. If constraints are to be enforced by a model editor tool, then the
 * tool must understand the syntax and semantics of the constraint language.
 * Because the choice of language is arbitrary, constraints can be used as an
 * extension mechanism.
 *
 * <p>
