...
implements org.omg.java.cwm.objectmodel.relationships.AggregationKind {
  ...
  private static final java.util.List<String> typeName = java.util.Collections.unmodifiableList(java.util.Arrays.asList(new String[] {"Relationships","AggregationKind"}));
  ...
  public boolean equals( java.lang.Object other ) {
    return (other instanceof org.omg.java.cwm.objectmodel.relationships.AggregationKindEnum) ? other == this : false;
  }
